...
def eat_ghost(power_pellet_active, touching_ghost):
    ...
    """
    value1 = power_pellet_active and touching_ghost
    return value1
...
def score(touching_power_pellet, touching_dot):
    ...
    """
    value2 = touching_power_pellet or touching_dot
    return value2
...
def lose(power_pellet_active, touching_ghost):
    ...
    """
    value3 = touching_ghost and not power_pellet_active
    return value3
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    value4 = has_eaten_all_dots and not lose(power_pellet_active, touching_ghost)
    return value4
