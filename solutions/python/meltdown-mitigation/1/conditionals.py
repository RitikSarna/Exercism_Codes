...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if (power >= theoretical_max_power * 0.8):
        say = 'green'
    elif (power <= theoretical_max_power * 0.8 and power >= theoretical_max_power * 0.6):
        say = 'orange'
    elif (power <= theoretical_max_power * 0.6 and power >= theoretical_max_power * 0.3):
        say = 'red'
    else:
        say = 'black'
